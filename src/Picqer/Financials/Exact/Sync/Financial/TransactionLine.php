...
namespace Picqer\Financials\Exact\Sync\Financial;
 ...
 * @property Guid $EntryID The transaction lines that make up a financial entry share the same EntryID
 ...
 * @property Guid $Subscription Reference to subscription line
